...
class AnimeDetailsDirector extends StatelessWidget {
  final ComicDetail comic;

  const AnimeDetailsDirector({super.key, required this.comic});
  ...
  Widget build(BuildContext context) {
    ...
    final List<Director> directorsList = comic.directors ?? [];
